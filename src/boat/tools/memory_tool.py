...
class MemoryBackend:
    ...
    def view(self, path: str, view_range: Optional[List[int]] = None) -> str:
        ...
        if full_path.is_file():
            ...
            if view_range:
                ...
                # Add line numbers
                numbered_lines = [
                    f"{i + start:5d}: {line}" for i, line in enumerate(lines)
                ]
                return "\n".join(numbered_lines)
    ...
    def delete(self, path: str) -> str:  # type: ignore
        """
...
class MemoryTool(BaseTool):
    ...
    Example:
        ...
        from boat.tools import MemoryTool
    ...
    def parameters(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "properties": {
                ...
                "insert_line": {
                    "type": "integer",
                    "description": ("Line number to insert text at (1-indexed)"),
                },
                "insert_text": {
                    "type": "string",
