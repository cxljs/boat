...
class BaseChatCompletionClient(ComponentBase[BaseModel], ABC):
    ...
    Provides unified interface for OpenAI-compatible LLM providers
    ...
    def __init__(self, model: str, api_key: Optional[str] = None, **kwargs: Any):
        ...
        Args:
            model: The model identifier (e.g., "gpt-5.5", "gpt-4o-mini")
    ...
    def _convert_messages_to_api_format(
        ...
        for msg in messages:
            ...
            if isinstance(msg, MultiModalMessage):
                ...
                if msg.is_text():
                    ...
                    if msg.content and msg.content.strip():
                        content_parts.append({"type": "text", "text": msg.content})  # type: ignore
            ...
            api_messages.append(api_msg)  # type: ignore

        return api_messages  # type: ignore
