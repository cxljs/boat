"""
Discovery system for Boat entities.

Scans directories for Boat agents and orchestrators following
...
from .models import AgentInfo, Entity, OrchestratorInfo

logger: logging.Logger = logging.getLogger(__name__)


class BoatScanner:
    """Scans filesystem for Boat entities following naming conventions."""
    ...
    def discover_entities(self) -> List[Entity]:
        """Discover all Boat entities in the entities directory.

        Returns:
            List of discovered entities (agents, orchestrators)
        """
        ...
        logger.info(f"Discovered {len(discovered)} Boat entities")
        return discovered
    ...
    def clear_cache(self) -> None:
        ...
        for entity_id in list(self._entity_cache.keys()):
            sys.modules.pop(f"boat_entity_{entity_id}", None)
    ...
    def _find_entities_in_module(
        ...
        """Find agent and orchestrator entities in a loaded module.
    ...
    def _extract_entity_info_from_object(
        ...
        Args:
            obj: Entity object
            obj_type: Type of entity (agent, orchestrator)
    ...
    def _load_module(self, py_file: Path, entity_id: str) -> Optional[Any]:
        ...
        try:
            ...
            sys.modules[f"boat_entity_{entity_id}"] = module
    ...
    def _find_entity_in_module(self, module: Any) -> Optional[Any]:
        """Find Boat entity in a loaded module.
    ...
    def _is_valid_entity(self, obj: Any, expected_type: str) -> bool:
        """Check if object is a valid Boat entity.

        Args:
            obj: Object to validate
            expected_type: Expected type (agent, orchestrator)
