...
Run standalone (stdio):
    python -m boat.webui.mcp.servers.apps_server
"""
...
SALES: Dict[str, Dict[str, List[int]]] = {
    "north": {
        "revenue": [42, 55, 61, 58, 73, 80],
        "units": [120, 141, 158, 150, 190, 210],
    },
    "south": {
        "revenue": [31, 29, 44, 52, 49, 63],
        "units": [95, 88, 130, 149, 141, 176],
    },
    "europe": {
        "revenue": [58, 62, 60, 71, 84, 91],
        "units": [161, 172, 168, 199, 231, 254],
    },
}
...
(() => {
  ...
  call("ui/initialize", {
    ...
    clientInfo: { name: "boat-lab-apps-view", version: "1.0.0" },
