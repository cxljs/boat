/**
 * ExamplesGallery - Shows available examples from GitHub when no local agents/orchestrators found
...
import { Bot, Users, Download, CheckCircle2, AlertCircle } from "lucide-react";
...
export function ExamplesGallery({ onExampleLoaded }: ExamplesGalleryProps) {
  ...
  return (
    <div className="w-full max-w-6xl p-4">
      {/* Header */}
      <div className="mb-6">
        <h2 className="text-lg font-semibold mb-2">Try Example Agents & Orchestrators</h2>
