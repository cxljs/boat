/**
 * Boat TypeScript type definitions
 * Aligned with the Boat Python backend types
 */

// Usage Statistics (from boat.types)
...
// Base Message Types (from boat.messages)
...
export type Entity = AgentInfo | OrchestratorInfo;
