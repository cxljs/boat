"""Converters between Boat domain types and DB models.
...
def orchestration_response_to_db_run(
    ...
    return DBRun(
        ...
        status="completed",
        finish_reason=response.stop_message.source
...
def db_to_dataset(db_dataset: DBDataset, db_tasks: list[DBTask]) -> Dataset:
