"""
Basic evaluation example for boat.
...
from boat.eval import AgentEvalTarget, EvalRunner, LLMEvalJudge, ModelEvalTarget
from boat.types import Task


async def main():
    """Run a basic evaluation example."""
    print("🧪 Basic Boat Evaluation Example")
    print("=" * 50)
    ...
    print("🏃 Created runner with parallel execution")
