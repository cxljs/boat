...
essential for component persistence, UI integration, and system interoperability.
"""
...
ComponentType = Union[
    Literal["model", "agent", "tool", "termination", "orchestrator"],
    str,
]
...
class ComponentModel(BaseModel):
    ...
    back into instances, supporting component persistence and UI integration.
    """
    ...
    Example: "boat.agents.Agent"
    """

    component_type: ComponentType | None = None
    """
    Logical type of the component (e.g., 'agent', 'orchestrator', 'model').
...
WELL_KNOWN_PROVIDERS = {
    # Boat Model Clients
    "openai_chat_completion_client": "boat.llm.OpenAIChatCompletionClient",
    "OpenAIChatCompletionClient": "boat.llm.OpenAIChatCompletionClient",
    "model_client": "boat.llm.OpenAIChatCompletionClient",  # Default model client
    # Boat Agents
    "agent": "boat.agents.Agent",
    "Agent": "boat.agents.Agent",
    # Boat Memory
    "list_memory": "boat.memory.ListMemory",
    "ListMemory": "boat.memory.ListMemory",
    "file_memory": "boat.memory.FileMemory",
    "FileMemory": "boat.memory.FileMemory",
    "memory": "boat.memory.ListMemory",  # Default memory
    # Boat Termination
    "max_message_termination": "boat.termination.MaxMessageTermination",
    "MaxMessageTermination": "boat.termination.MaxMessageTermination",
    "text_mention_termination": "boat.termination.TextMentionTermination",
    "TextMentionTermination": "boat.termination.TextMentionTermination",
    "composite_termination": "boat.termination.CompositeTermination",
    "CompositeTermination": "boat.termination.CompositeTermination",
    "termination": "boat.termination.MaxMessageTermination",  # Default termination
    # Boat Orchestrators
    "round_robin_orchestrator": "boat.orchestration.RoundRobinOrchestrator",
    "RoundRobinOrchestrator": "boat.orchestration.RoundRobinOrchestrator",
    "ai_orchestrator": "boat.orchestration.AIOrchestrator",
    "AIOrchestrator": "boat.orchestration.AIOrchestrator",
    "orchestrator": "boat.orchestration.RoundRobinOrchestrator",  # Default orchestrator
}
...
class ComponentFromConfig(Generic[FromConfigT]):
    ...
    @classmethod
    def from_config_past_version(cls, config: Dict[str, Any], version: int) -> Self:
...
class ComponentLoader:
    ...
    def load_component(
        ...
        """Load a component from a model. Intended to be used with the return type of :py:meth:`boat.ComponentConfig.dump_component`.

        Example:

            .. code-block:: python

                from boat import ComponentModel
                from boat.models import ChatCompletionClient
...
class Component(
    ...
    """
    Base class for serializable Boat components.
    ...
    .. code-block:: python
        ...
        from pydantic import BaseModel
        from boat import Component, ComponentBase
