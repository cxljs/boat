...
from boat.messages import AssistantMessage, Message, ToolMessage, UserMessage
from boat.orchestration import RoundRobinOrchestrator
from boat.termination import (
...
def test_termination_reset_functionality():
    ...
    for term in terminations:
        if isinstance(term, TimeoutTermination):
            ...
            time.sleep(0.2)
            term.check([UserMessage(content="Trigger", source="user")])
        else:
