...
from boat.messages import AssistantMessage  # noqa: E402
from boat.store.converters import (  # noqa: E402
    dataset_to_db,
    db_to_dataset,
)
from boat.store.models import DBTask  # noqa: E402
from boat.store.store import BoatStore  # noqa: E402
from boat.types import AgentResponse, Task, Usage  # noqa: E402
...
def _dataset(name: str) -> "object":
    ...
    from boat.eval.dataset import Dataset
...
async def test_eval_run_accepts_a_path_for_file_path(store):
    ...
    from boat.eval.results import EvalResults
    ...
    eval_run_id = await store.save_eval_run_from_results(
        results,
        file_path=store._eval_dir / "x.json",  # a Path, deliberately
    )
