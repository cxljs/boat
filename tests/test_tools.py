"""
Comprehensive tests for Boat tool system.
...
from boat import Agent, BaseTool, FunctionTool
from boat.llm import BaseChatCompletionClient
from boat.messages import AssistantMessage
from boat.tools import create_core_tools
from boat.tools.coding_tools import WriteFileTool
from boat.types import ChatCompletionResult, ToolResult, Usage
...
async def test_think_tool():
    ...
    from boat.tools.core_tools import ThinkTool
...
async def test_forced_tool_use():
    ...
    agent = Agent(
        ...
        model_client=client,
        required_tools=["calculator", "datetime"],
    )
    ...
    assert "datetime" in system_msg.content
