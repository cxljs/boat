"""
Test component serialization across the boat framework.
...
from boat.memory import FileMemory, ListMemory
from boat.orchestration import AIOrchestrator, RoundRobinOrchestrator
from boat.termination import (
    CompositeTermination,
    MaxMessageTermination,
    TextMentionTermination,
)
from boat.tools import FunctionTool
