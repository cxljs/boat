...
from boat.tools import MemoryBackend, MemoryTool
from boat.types import ToolResult
...
class TestMemoryBackend:
    ...
    def test_create_file(self, memory_backend):
        ...
        # Verify content
        created_content = (memory_backend.base_path / "test.md").read_text()
    ...
    def test_create_file_with_directories(self, memory_backend):
        ...
        result = memory_backend.create("/memories/patterns/bug.md", "Bug notes")
    ...
    def test_str_replace(self, memory_backend):
        ...
        result = memory_backend.str_replace("/memories/test.txt", "Hello", "Hi")
    ...
    def test_str_replace_not_found(self, memory_backend):
        ...
        with pytest.raises(ValueError, match="Text not found"):
            memory_backend.str_replace("/memories/test.txt", "Goodbye", "Hi")
...
class TestMemoryTool:
    ...
    async def test_execute_view(self, memory_tool):
        ...
        result = await memory_tool.execute({"command": "view", "path": "/memories"})
