"""Minimal tests for Boat WebUI discovery functionality."""

import types
from typing import Any
from unittest.mock import Mock

from boat.webui.discovery import BoatScanner
...
def test_get_entity_id() -> None:
    ...
    # Test nested file
    py_file = Path("/base/dir/subdir/orchestrator.py")
    entity_id = scanner._get_entity_id(py_file)
    assert entity_id == "subdir.orchestrator"
