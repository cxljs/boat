...
from boat.webui.server import BoatWebUIServer
...
def test_cors_enabled():
    ...
    server = BoatWebUIServer(enable_cors=True, cors_origins=["*"])
...
def test_cors_disabled():
    ...
    server = BoatWebUIServer(enable_cors=False)
    app = server.create_app()
