...
from boat.messages import AssistantMessage, ToolMessage, UserMessage
from boat.types import ChatCompletionResult, RunTrajectory, Task, Usage
...
async def test_eval_runner_with_agent():
    ...
    tasks = [
        ...
        Task(name="Math2", input="3+3", expected_output="6"),  # Correct answer for 3+3
    ]
